<template>
    <div class="min-h-screen bg-gray-100 p-10" style="font-family: 'Prompt', sans-serif;">
        <h1 class="text-2x1 font-bold text-center pt-15 pb-5">รายงานผลการประเมินบุคลากร</h1>

    <div class="bg-white p-6 rounded-xl shadow-md ">
        <button @click="clearEvaluations" class="mt-4 bg-red-500 hover
:bg-red-600 text-white px-4 py-2 rounded-1g mb-5">
